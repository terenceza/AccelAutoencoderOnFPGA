...
$(ObjDir)/TestAccelAutoencoder.cpp_pre.cpp.tb.o : TestAccelAutoencoder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling TestAccelAutoencoder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/AutoEncoder.cpp_pre.cpp.tb.o : AutoEncoder.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling AutoEncoder.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
