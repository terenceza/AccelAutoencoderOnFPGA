...
# ==============================================================
set ::env(PATH) "$::env(PATH);U:/VivadoSuite-10-19-2022/Vitis_HLS/2022.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);U:/VivadoSuite-10-19-2022/Vitis_HLS/2022.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);U:/VivadoSuite-10-19-2022/Vitis_HLS/2022.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);U:/VivadoSuite-10-19-2022/Vitis_HLS/2022.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Autoencoder.autotvin.dat"
	set constFileTvOut       "Autoencoder.autotvout.dat"
	set constFileHdlTvIn     "Autoencoder.autohdltvin.dat"
	set constFileHdlTvOut    "Autoencoder.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
