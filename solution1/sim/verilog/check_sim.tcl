...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Autoencoder.autotvin_gmem.dat"
         "c.Autoencoder.autotvin_gmem0.dat"
         "c.Autoencoder.autotvin_DataIn.dat"
         "c.Autoencoder.autotvin_EncWeights.dat"
         "c.Autoencoder.autotvin_DecWeights.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Autoencoder.autotvout_ErrorP.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
