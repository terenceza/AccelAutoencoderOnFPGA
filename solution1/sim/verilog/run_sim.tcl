...
if {[file isfile Autoencoder.autotvin.dat]} {
	file delete -force Autoencoder.autotvin.dat
}

if {[file isfile Autoencoder.autotvout.dat]} {
	file delete -force Autoencoder.autotvout.dat
}
