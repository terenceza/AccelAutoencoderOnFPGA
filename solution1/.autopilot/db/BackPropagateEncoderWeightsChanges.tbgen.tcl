set moduleName BackPropagateEncoderWeightsChanges
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {BackPropagateEncoderWeightsChanges}
...
set portList { 
	...
	{ EncoderWeightChanges_address0 sc_out sc_lv 6 signal 0 } 
	{ EncoderWeightChanges_ce0 sc_out sc_logic 1 signal 0 } 
	{ EncoderWeightChanges_we0 sc_out sc_logic 1 signal 0 } 
	{ EncoderWeightChanges_d0 sc_out sc_lv 1 signal 0 } 
	{ TotalErrorDeltas_address0 sc_out sc_lv 6 signal 1 } 
	{ TotalErrorDeltas_ce0 sc_out sc_logic 1 signal 1 } 
	{ TotalErrorDeltas_we0 sc_out sc_logic 1 signal 1 } 
	{ TotalErrorDeltas_d0 sc_out sc_lv 1 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	EncoderWeightChanges { ap_memory {  { EncoderWeightChanges_address0 mem_address 1 6 }  { EncoderWeightChanges_ce0 mem_ce 1 1 }  { EncoderWeightChanges_we0 mem_we 1 1 }  { EncoderWeightChanges_d0 mem_din 1 1 } } }
	TotalErrorDeltas { ap_memory {  { TotalErrorDeltas_address0 mem_address 1 6 }  { TotalErrorDeltas_ce0 mem_ce 1 1 }  { TotalErrorDeltas_we0 mem_we 1 1 }  { TotalErrorDeltas_d0 mem_din 1 1 } } }
}
