...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { EncoderWeightChanges_address0 { O 6 vector } EncoderWeightChanges_ce0 { O 1 bit } EncoderWeightChanges_we0 { O 1 bit } EncoderWeightChanges_d0 { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { TotalErrorDeltas_address0 { O 6 vector } TotalErrorDeltas_ce0 { O 1 bit } TotalErrorDeltas_we0 { O 1 bit } TotalErrorDeltas_d0 { O 1 vector } } \
} "
} else {
