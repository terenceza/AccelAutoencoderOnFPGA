...
entity Autoencoder_Autoencoder_Pipeline_VITIS_LOOP_52_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Autoencoder_Autoencoder_Pipeline_VITIS_LOOP_52_1 is 
...
attribute shreg_extract : string;
    ...
    signal ap_sig_allocacmp_d_5 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    add_ln52_fu_81_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_d_5) + unsigned(ap_const_lv10_1));
    ...
    ap_sig_allocacmp_d_5_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, d_fu_46, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_d_5 <= ap_const_lv10_0;
        else 
            ap_sig_allocacmp_d_5 <= d_fu_46;
        end if; 
    end process;
    ...
    icmp_ln52_fu_75_p2 <= "1" when (ap_sig_allocacmp_d_5 = ap_const_lv10_258) else "0";
